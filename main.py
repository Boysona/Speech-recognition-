...
_service_account_info = json.loads(SERVICE_ACCOUNT_JSON_STRING)

# Initialize the Firebase app with a Certificate object built from the dict
firebase_cert = credentials.Certificate(_service_account_info)
