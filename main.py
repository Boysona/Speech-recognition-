...
# --- MODIFIED: Import speech_recognition for speech-to-text ---
...
# --- MODIFIED: Removed FasterWhisper model initialization ---
# WHISPER_MODEL = None # No longer needed
...
def process_media_file(message, stop_typing, is_document_video):
    ...
    convert it to WAV, run speech_recognition transcription,
    ...
    try:
        ...
        # Convert whatever we downloaded into a 16kHz, mono WAV for speech_recognition
        ...
        # --- MODIFIED: Transcribe using speech_recognition ---
...
# --- MODIFIED: Function to transcribe audio using speech_recognition ---
def transcribe_audio_with_speech_recognition(audio_path: str, lang_code: str) -> str | None:
    ...
    try:
        ...
        # You can choose different recognizers.
        # For local Whisper model, you'd use r.recognize_whisper
        # For Google Web Speech API (free, but requires internet), use r.recognize_google
        # For other cloud-based services, refer to speech_recognition documentation.
        
        # Using Google Web Speech API for simplicity and no extra local model download
        transcription = r.recognize_google(audio, language=lang_code)
        
        # If you were to use a local Whisper model with speech_recognition, it would look like:
        # transcription = r.recognize_whisper(audio, model="tiny", language=lang_code)
        ...
        logging.error(f"Speech Recognition transcription error: {e}")
        return None
